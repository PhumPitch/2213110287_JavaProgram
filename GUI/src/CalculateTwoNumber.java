...
public class CalculateTwoNumber extends JFrame {
	...
	public CalculateTwoNumber() {
		...
		lblResult.setBounds(256, 131, 99, 19);
		...
		final JCheckBox chkDialogbox = new JCheckBox("Show Result a Dialog");
		chkDialogbox.setBounds(142, 182, 130, 23);
